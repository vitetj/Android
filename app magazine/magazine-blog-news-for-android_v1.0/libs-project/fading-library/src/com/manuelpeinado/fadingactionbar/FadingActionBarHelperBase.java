...
public abstract class FadingActionBarHelperBase {
	...
	private HeaderImageLoaderable mHeaderLoader;

	public interface HeaderImageLoaderable {
		public void loadHeaderImage(ImageView image);
	}

	public void setHeaderLoader(HeaderImageLoaderable headerLoader) {
	...
	public final View createView(LayoutInflater inflater) {
		...
		if (mHeaderView == null) {
			...
			View mainHeaderImage = ((RelativeLayout) mHeaderView).getChildAt(0);

			if (mHeaderLoader != null && mainHeaderImage instanceof ImageView) {
				mHeaderLoader.loadHeaderImage((ImageView) mainHeaderImage);
			}
		}
